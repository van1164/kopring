...
application.properties에서 mysql주소를 localhost가 아닌 host.docker.internal로 설정시 해결
```
spring.datasource.url=jdbc:mysql://host.docker.internal:3306/vote_share?useSSL=false
```
